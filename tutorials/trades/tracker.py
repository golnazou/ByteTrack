...
class Tracker(object):
    ...
    def step(self, results_with_low, public_det=None):
        ...
        track_boxes = np.array([[track['bbox'][0], track['bbox'][1],
                                 track['bbox'][2], track['bbox'][3]] for track in self.tracks], float32)  # M x 4
        det_boxes = np.array([[item['bbox'][0], item['bbox'][1],
                               item['bbox'][2], item['bbox'][3]] for item in results], float32)  # N x 4
        ...
        if N > 0 and M > 0:
            ...
            track_boxes_second = np.array([[track['bbox'][0], track['bbox'][1],
                                 track['bbox'][2], track['bbox'][3]] for track in self_tracks_second], float32)  # M x 4
            det_boxes_second = np.array([[item['bbox'][0], item['bbox'][1],
                                  item['bbox'][2], item['bbox'][3]] for item in results_second], float32)  # N x 4
